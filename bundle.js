...
var SIGN_IN_FAILURE = exports.SIGN_IN_FAILURE = 'SIGN_IN_FAILURE';

// new user
var NEW_USER_REQUEST = exports.NEW_USER_REQUEST = 'NEW_USER_REQUEST';
...
// api types
var TRACK_REQUEST = exports.TRACK_REQUEST = 'TRACK_REQUEST';
var ALBUM_REQUEST = exports.ALBUM_REQUEST = 'ALBUM_REQUEST';
var ARTIST_REQUEST = exports.ARTIST_REQUEST = 'ARTIST_REQUEST';

// CRUD-related
var OPTION_SELECTED = exports.OPTION_SELECTED = 'OPTION_SELECTED';
var OPTION_DELETED = exports.OPTION_DELETED = 'OPTION_DELETED';
var OPTION_RANK_CHANGED = exports.OPTION_RANK_CHANGED = 'OPTION_RANK_CHANGED';

// database types
var SAVED_TO_LIB = exports.SAVED_TO_LIB = 'SAVED_TO_LIB';
var GET_SAVED_TYPE = exports.GET_SAVED_TYPE = 'GET_SAVED_TYPE';
var DATA_RETRIEVED = exports.DATA_RETRIEVED = 'DATA_RETRIEVED';

// common changes
var INPUT_UPDATE = exports.INPUT_UPDATE = 'INPUT_UPDATE';
var SELECTION_CHANGED = exports.SELECTION_CHANGED = 'SELECTION_CHANGED';
...
exports.dataRetrieved = exports.getSavedType = exports.itemSaved = exports.responseBack = exports.makeSelection = exports.getDatabaseData = exports.saveToDatabase = exports.getSearch = exports.reveal = undefined;

var _types = __webpack_require__(4);

var _apiServices = __webpack_require__(34);

var _artistAction = __webpack_require__(91);

var _trackAction = __webpack_require__(92);

var _albumAction = __webpack_require__(93);

var reveal = exports.reveal = function reveal(type) {
    return function (dispatch) {
        // dispatch(makeSelection(type));
        if (type !== 'search') {
            (0, _apiServices.initiateDataGrab)(type).then(function (body) {
...
var getSearch = exports.getSearch = function getSearch(name, type) {
    return function (dispatch) {
        (0, _apiServices.makeApiCall)(name, type).then(function (res) {
            if (type === 'artist') {
                dispatch((0, _artistAction.artistsSearched)(res));
            } else if (type === 'track') {
                dispatch((0, _trackAction.tracksSearched)(res));
            } else if (type === 'album') {
                dispatch((0, _albumAction.albumsSearched)(res));
            }
...
var saveToDatabase = exports.saveToDatabase = function saveToDatabase(type, item) {
    return function (dispatch) {
        (0, _apiServices.initiateSave)(type, item).then(function (res) {
            console.log('res: ', res);
        });
        // .then((res) => {
...
var getDatabaseData = exports.getDatabaseData = function getDatabaseData(type) {
    return function (dispatch) {
        (0, _apiServices.initiateDataGrab)(type);
    };
};

var makeSelection = exports.makeSelection = function makeSelection(value) {
    return {
        type: _types.OPTION_SELECTED,
        payload: value
    };
};

var responseBack = exports.responseBack = function responseBack(value) {
    return {
        type: _types.API_SUCCESS,
        payload: value
    };
};

var itemSaved = exports.itemSaved = function itemSaved(value) {
    return {
        type: _types.SAVED_TO_LIB,
        payload: value
    };
};

var getSavedType = exports.getSavedType = function getSavedType(value) {
    return {
        type: _types.GET_SAVED_TYPE,
        payload: value
    };
};

var dataRetrieved = exports.dataRetrieved = function dataRetrieved(value) {
    return {
        type: _types.DATA_RETRIEVED,
        payload: value
    };
};
...
var getSavedArtists = exports.getSavedArtists = function getSavedArtists() {
...
var getSavedAlbums = exports.getSavedAlbums = function getSavedAlbums() {
    return fetch('/albums', {
        method: 'POST',
        data: {}
    }).then(function (response) {
...
var getSavedTracks = exports.getSavedTracks = function getSavedTracks() {
...
var initiateSave = exports.initiateSave = function initiateSave(type, item) {
...
var initiateDataGrab = exports.initiateDataGrab = function initiateDataGrab(type) {
    if (type === 'artists') {
...
var makeApiCall = exports.makeApiCall = function makeApiCall(name, type) {
...
var _registerServiceWorker = __webpack_require__(101);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(15),B=__webpack_require__(5),C=__webpack_require__(3),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(20),D=__webpack_require__(7);
...
// module
exports.push([module.i, ".sidebar-div {\n    height: 100vh;\n    width: 20vw;\n    position: fixed;\n    top: 0;\n    right: 0;\n    background-color: black;\n    color: green;\n}\n\n.nav-ul {\n    text-decoration: none;\n}\n\n.nav-li {\n    display: inline-block;\n    padding: 20px;\n    cursor: pointer;\n}\n\n.non-sidebar {\n    width: 80vw;\n    height: 100vh;\n}\n\n.bottom-border {\n    border-top: 1px solid black;\n}", ""]);
...
var _Launch = __webpack_require__(80);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(_Launch2.default, null);
        }
    }]);
...
var _ListWrapper = __webpack_require__(81);

var _NavWrapper = __webpack_require__(87);

var _SidebarWrapper = __webpack_require__(89);

var _queryAction = __webpack_require__(9);
...
var Launch = function (_Component) {
    ...
    _createClass(Launch, [{
        ...
        value: function componentDidMount() {
            ...
            var split = window.location.href.split('#access_token=')[1];
            ...
            fetch('https://api.spotify.com/v1/me', {
                ...
                _this2.userId = res.id;
                _this2.setState({ userId: _this2.userId });
            }).catch(function (err) {
                throw new Error(err);
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_NavWrapper.NavWrapper, {
                        data: this.props,
                        reveal: this.props.reveal
                    }),
                    _react2.default.createElement(_ListWrapper.ListWrapper, {
                ...
                _react2.default.createElement(_SidebarWrapper.SidebarWrapper, null)
            );
        }
    }]);
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    reveal: _queryAction.reveal,
    getSearch: _queryAction.getSearch,
    saveToDatabase: _queryAction.saveToDatabase,
    getDatabaseData: _queryAction.getDatabaseData
})(Launch);
...
var ListWrapper = exports.ListWrapper = function (_Component) {
    _inherits(ListWrapper, _Component);

    function ListWrapper() {
        _classCallCheck(this, ListWrapper);

        return _possibleConstructorReturn(this, (ListWrapper.__proto__ || Object.getPrototypeOf(ListWrapper)).apply(this, arguments));
    }
...
var _Artists = __webpack_require__(83);

var _Albums = __webpack_require__(84);

var _Tracks = __webpack_require__(85);

var _GenericResponse = __webpack_require__(86);
...
var ListItem = exports.ListItem = function (_Component) {
    ...
    _createClass(ListItem, [{
        ...
        value: function onPress() {
            var name = document.querySelector('#search-name').value;
            var type = document.querySelector('#search-type').value;
            this.type = type;
        ...
        value: function render() {
            ...
            if (this.props.selected === 'artists') {
                return _react2.default.createElement(_Artists.Artists, {
                    retrievedFromDatabase: this.props.retrievedFromDatabase
                });
            } else if (this.props.selected === 'albums') {
                return _react2.default.createElement(_Albums.Albums, {
                    retrievedFromDatabase: this.props.retrievedFromDatabase
                });
            } else if (this.props.selected === 'tracks') {
                return _react2.default.createElement(_Tracks.Tracks, {
                    retrievedFromDatabase: this.props.retrievedFromDatabase
                });
                ...
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_GenericResponse.GenericResponse, {
...
var Artists = exports.Artists = function (_Component) {
    ...
    _createClass(Artists, [{
        key: 'render',
        value: function render() {
            return this.props.retrievedFromDatabase.map(function (res) {
                return _react2.default.createElement(
                    'div',
                    {
                        key: res.id },
...
var Albums = exports.Albums = function (_Component) {
...
var Tracks = exports.Tracks = function (_Component) {
...
exports.GenericResponse = undefined;
...
var GenericResponse = exports.GenericResponse = function (_Component) {
    _inherits(GenericResponse, _Component);

    function GenericResponse() {
        _classCallCheck(this, GenericResponse);

        return _possibleConstructorReturn(this, (GenericResponse.__proto__ || Object.getPrototypeOf(GenericResponse)).apply(this, arguments));
    }

    _createClass(GenericResponse, [{
        key: 'saveToLibrary',
        value: function saveToLibrary(item) {
        ...
        value: function render() {
            ...
            if (this.props.type === 'track') {
                return this.props.response.tracks.items.map(function (item) {
                    return _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            {
                                onClick: function onClick() {
                                    return _this2.saveToLibrary(item);
                                }
                            },
                            'Save to Library'
                        )
                ...
                return this.props.response.albums.items.map(function (item) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'bottom-border',
                            key: item.href
                ...
                return this.props.response.artists.items.map(function (item) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'bottom-border',
                            key: item.href
...
var NavWrapper = exports.NavWrapper = function (_Component) {
    _inherits(NavWrapper, _Component);

    function NavWrapper() {
        _classCallCheck(this, NavWrapper);

        return _possibleConstructorReturn(this, (NavWrapper.__proto__ || Object.getPrototypeOf(NavWrapper)).apply(this, arguments));
    }

    _createClass(NavWrapper, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'ul',
                { className: 'nav-ul' },
                _react2.default.createElement(_NavItem.NavItem, {
...
var NavItem = exports.NavItem = function (_Component) {
    ...
    _createClass(NavItem, [{
        ...
        value: function render() {
            ...
            this.navs = [{
                type: 'artists',
                run: function run() {
                    _this2.props.data.reveal('artists');
                }
            }, {
                type: 'albums',
                run: function run() {
                    _this2.props.data.reveal('albums');
                }
            }, {
                type: 'tracks',
                run: function run() {
                    _this2.props.data.reveal('tracks');
                }
            }, {
                type: 'search',
                run: function run() {
                    _this2.props.data.reveal('search');
                }
            }];

            return this.navs.map(function (nav) {
                return _react2.default.createElement(
                    'li',
                    {
                        onClick: function onClick() {
...
exports.SidebarWrapper = undefined;
...
var _SidebarItem = __webpack_require__(90);
...
var SidebarWrapper = exports.SidebarWrapper = function (_Component) {
    _inherits(SidebarWrapper, _Component);
    ...
    _createClass(SidebarWrapper, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_SidebarItem.SidebarItem, null);
        }
    }]);
...
var SidebarItem = exports.SidebarItem = function (_Component) {
...
exports.artistsRequested = exports.artistsSearched = undefined;
...
var artistsSearched = exports.artistsSearched = function artistsSearched(res) {
    return function (dispatch) {
        dispatch(artistsRequested(res));
    };
};

var artistsRequested = exports.artistsRequested = function artistsRequested(value) {
    return {
        type: _types.ARTIST_REQUEST,
        payload: value
    };
};
...
exports.trackRequested = exports.tracksSearched = undefined;

var _types = __webpack_require__(4);

var _queryAction = __webpack_require__(9);

var tracksSearched = exports.tracksSearched = function tracksSearched(res) {
    return function (dispatch) {
        dispatch(trackRequested(res));
    };
};

var trackRequested = exports.trackRequested = function trackRequested(value) {
    return {
        type: _types.TRACK_REQUEST,
        payload: value
    };
};
...
exports.albumRequested = exports.albumsSearched = undefined;

var _types = __webpack_require__(4);

var _queryAction = __webpack_require__(9);

var albumsSearched = exports.albumsSearched = function albumsSearched(res) {
    return function (dispatch) {
        dispatch(albumRequested(res));
    };
};

var albumRequested = exports.albumRequested = function albumRequested(value) {
    return {
        type: _types.ALBUM_REQUEST,
        payload: value
    };
};
...
var reducer = (0, _redux.combineReducers)({
    albums: _albumReducer2.default,
    artists: _artistReducer2.default,
    tracks: _trackReducer2.default,
    queried: _queryReducer2.default
});
...
var initialState = [{ selected: 'search' }];
...
exports.default = function () {
    ...
    switch (action.type) {
        case _types.API_SUCCESS:
            return _extends({}, state, { response: action.payload });
        case _types.OPTION_SELECTED:
            return _extends({}, state, { selected: action.payload });
        case _types.DATA_RETRIEVED:
            return _extends({}, state, { retrieved: action.payload });
        default:
            return _extends({}, state);
    }
};
